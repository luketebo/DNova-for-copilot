...
export const TOOL_DRIFT_NOTICE_START = '[dnova-copilot-tool-drift-notice-start]: #';
export const TOOL_DRIFT_NOTICE_END = '[dnova-copilot-tool-drift-notice-end]: #';
export const VISION_PROXY_NOTICE_START = '[dnova-copilot-vision-proxy-notice-start]: #';
export const VISION_PROXY_NOTICE_END = '[dnova-copilot-vision-proxy-notice-end]: #';
