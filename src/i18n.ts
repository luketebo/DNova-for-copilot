...
const zh: Translations = {
	...
	'mcp.startup.httpFailed': '❌ ABAP ADT MCP HTTP 服务不可用：{0}',
	'mcp.startup.httpDisabled': '⚠️ ABAP ADT MCP HTTP 服务已关闭，MCP 当前不可用。',
	'mcp.startup.openConfig': '查看配置',
	'mcp.startup.retry': '重试',
...
const en: Translations = {
	...
	'mcp.startup.httpFailed': '❌ ABAP ADT MCP HTTP service is unavailable: {0}',
	'mcp.startup.httpDisabled': '⚠️ ABAP ADT MCP HTTP service is disabled; MCP is currently unavailable.',
	'mcp.startup.openConfig': 'View Config',
	'mcp.startup.retry': 'Retry',
